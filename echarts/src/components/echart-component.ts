...
export class EChartsComponent implements OnChanges, OnDestroy {

  //copy of https://github.com/xieziyu/ngx-echarts/blob/master/src/directive/angular-echarts.directive.ts
  ...
  @Output()
  chartInit: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartClick: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartDblClick: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartMouseDown: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartMouseUp: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartMouseOver: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartMouseOut: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartGlobalOut: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartContextMenu: EventEmitter<any> = new EventEmitter<any>();

  @Output()
  chartDataZoom: EventEmitter<any> = new EventEmitter<any>();
  ...
  private createChart() {
    ...
    if (this.theme) {
      return this.ngZone.runOutsideAngular(() => {
        return echarts.init(this.root.nativeElement, this.theme)
      });
    } else {
      return this.ngZone.runOutsideAngular(() => {
        return echarts.init(this.root.nativeElement)
      });
    }
  }
